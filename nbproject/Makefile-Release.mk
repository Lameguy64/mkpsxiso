...
${OBJECTDIR}/src/cdwriter.o: src/cdwriter.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/C/tinyxml2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cdwriter.o src/cdwriter.cpp

${OBJECTDIR}/src/edcecc.o: src/edcecc.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/C/tinyxml2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/edcecc.o src/edcecc.cpp

${OBJECTDIR}/src/iso.o: src/iso.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/C/tinyxml2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/iso.o src/iso.cpp

${OBJECTDIR}/src/main.o: src/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/C/tinyxml2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.cpp
