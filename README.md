...
On ext2/3/4 filesystems, the minimum timestamp you can set is 1901/12/13, which makes some games that has files/folders with dates older than that (like Vagrant Story) impossible to make a 1:1 copy. A workaround to this is to work on a filesystem that has better date support, like ntfs.
